    ...
    function handleJSX(node) {
      ...
      Object.keys(childrenGroupedByLine).forEach((_line) => {
        ...
        childrenGroupedByLine[line].forEach((child, i) => {
          ...
          const leadingSpace = Boolean(prevChild && spaceBetweenPrev());
          const trailingSpace = Boolean(nextChild && spaceBetweenNext());
          const leadingNewLine = Boolean(prevChild);
          const trailingNewLine = Boolean(nextChild);
